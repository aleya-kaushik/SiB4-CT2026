...
!.. for GFED4.1s method - these are the pools that are set up to always burn
!.. would go down the list of other pools if totemis was not satisfied

tmpvdr = ( (poollt%poolpft_lay(lp,1) &
